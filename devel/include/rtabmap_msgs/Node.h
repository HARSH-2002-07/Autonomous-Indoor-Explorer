...
struct Printer< ::rtabmap_msgs::Node_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rtabmap_msgs::Node_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "word_id_keys: ";
    if (v.word_id_keys.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.word_id_keys.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int32_t>::stream(s, true ? std::string() : indent + "    ", v.word_id_keys[i]);
    }
    if (v.word_id_keys.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "word_id_values: ";
    if (v.word_id_values.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.word_id_values.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int32_t>::stream(s, true ? std::string() : indent + "    ", v.word_id_values[i]);
    }
    if (v.word_id_values.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.word_kpts.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::rtabmap_msgs::KeyPoint_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.word_kpts[i]);
    }
    if (v.word_kpts.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.word_pts.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::rtabmap_msgs::Point3f_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.word_pts[i]);
    }
    if (v.word_pts.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "word_descriptors: ";
    if (v.word_descriptors.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.word_descriptors.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.word_descriptors[i]);
    }
    if (v.word_descriptors.empty() || true)
      s << "]";
    if (true || !indent.empty())
